...
# Аргументы могут иметь значению по умолчанию
...
# Пример 2: Передача обьекта лямбды в функцию в качестве парамет
def func_10(f, n):
    res = f(n)
    print(res)
